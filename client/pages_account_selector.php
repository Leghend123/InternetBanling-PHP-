...
while($row = $result->fetch_assoc()){
    ...
    $output .='
							...
							<tr>
								<td>
								<a href="pages_wire_transfer.php?id='.$row['account_id'].' " style="text-decoration:none; color:black">'.$row["acc_type"].' <br><span>'.$row["account_number"].'</span></a>
								</td>
								<td>
								 <a href="pages_wire_transfer.php?id='.$row['account_id'].' " style="text-decoration:none; color:black">Current balance <br><span style="font-size:15px; color:navy; font-weight:bold">'.$formatted_balance.'</span></a>
								 </td>
								<td>
								<a href="pages_wire_transfer.php?id='.$row['account_id'].' " style="text-decoration:none; color:black">Available balance <br> <span style="font-size:15px;color:navy; font-weight:bold "> '.$formatted_balance.'</</span>
								</a>
								</td>
								<td>
								<a href="pages_wire_transfer.php?id='.$row['account_id'].' "><button class="btn btn-primary">Click to Make A Transfer</button></a>
								</td>
							</tr>
				...
				<div class="col-md-10">
					<table class=" table table-responsive table-borderless ">
			    		<thead>
			    			...
			    			<tr>
			    				<td>Select the account for the wire transfer</td>
			    			</tr>
			    		</thead>
			    	</table>
				</div>
