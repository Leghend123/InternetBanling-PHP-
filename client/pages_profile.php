            ...
            ?>
                <section class="content-header">
                    <div class="container-fluid" style="margin-top:30px">
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                <h4 style="color: #007b85"><?php echo $row->name; ?> Profile</h4>
                            </div>
                            <!-- <div class="col-sm-6">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            <li class="list-group-item">
                                                <b>ID No.: </b> <a class="float-right"style="text-decoration:none; color: black;"><?php echo $row->national_id; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Email: </b> <a class="float-right"style="text-decoration:none; color: black;"><?php echo $row->email; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Phone: </b> <a class="float-right"style="text-decoration:none; color: black;"><?php echo $row->phone; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>ClientNo: </b> <a class="float-right" style="text-decoration:none; color: black;"><?php echo $row->client_number; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Address: </b> <a class="float-right" style="text-decoration:none; color: black;"><?php echo $row->address; ?></a>
                                            </li>
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item"><a class="nav-link active" id="updateProfileTab" href="#" onclick="showTab('update_Profile')">Update Profile</a></li>
                                            <li class="nav-item"><a class="nav-link " id="changePasswordTab" href="#" onclick="showTab('Change_Password')">Change Password</a></li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
...
<script>
    function showTab(tabId) {
        ...
        // Update the active class for the navigation
        $('#myTabs .nav-link').removeClass('active');
        $('#myTabs a[href="#' + tabId + '"]').addClass('active');
    }
</script>
