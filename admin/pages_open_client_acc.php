...
if (isset($_POST['open_account'])) {
    ...
    $currency_type = $_POST['cur_type'];

    //Insert Captured information to a database table
    $query = "INSERT INTO iB_bankAccounts (acc_name, account_number, acc_type, acc_rates,currency_type, acc_status, acc_amount, client_id, client_name, client_national_id, client_phone, client_number, client_email, client_adr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
    $rc = $stmt->bind_param('ssssssssssssss', $acc_name, $account_number, $acc_type,$acc_rates,$currency_type, $acc_status, $acc_amount, $client_id, $client_name, $client_national_id, $client_phone, $client_number, $client_email, $client_adr);
    $stmt->execute();
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class=" col-md-6 form-group">
                                                    ...
                                                    <select class="form-control" onChange="getiBankAccs(this.value);" name="cur_type">
                                                        <option>Select Any Currency types</option>
