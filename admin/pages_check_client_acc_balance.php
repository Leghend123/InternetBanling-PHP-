                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>GH₵ <?php echo $deposit; ?></td>
                                                        <td>GH₵ <?php echo $withdrawal; ?></td>
                                                        <td>GH₵ <?php echo $Transfer; ?></td>
                                                        <td>GH₵ <?php echo $money_in; ?></td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>GH₵ <?php echo $rate_amt; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>GH₵ <?php echo $totalMoney; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
