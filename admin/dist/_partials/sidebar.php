      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                  <a href="pages_wire_transfer.php" class="nav-link">
                    <i class="fas fa-random nav-icon"></i>
                    <p>Wire Transfer</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_pay_bills.php" class="nav-link">
                    <i class="fas fa-random nav-icon"></i>
                    <p>Pay Bills</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="pages_wire_history.php" class="nav-link">
                <i class="nav-icon fas fa-exchange-alt"></i>
                <p>
                  Wire Transfers History
                </p>
              </a>
            </li>
