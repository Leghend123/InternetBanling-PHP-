          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Approve or Reject these Pending deposits</h3>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $output="";
                    //fetch all iB_Accs
                    $ret = "SELECT * FROM ib_transactions WHERE tr_status = 'Pending' AND depo_type = 'Cash' ";
