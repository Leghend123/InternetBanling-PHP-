...
if (isset($_POST['deposit'])) {
    ...
    //Notication
    $notification_details = "$client_name Has Transfered GH₵ $transaction_amt From Bank Account $account_number To Bank Account $receiving_acc_no";
    ...
    if ($transaction_amt > $amt) {
        $transaction_error  =  "You Do Not Have Sufficient Funds In Your Account For Transfer Your Current Account Balance Is GH₵ $amt";
    } else {


        //Insert Captured information to a database table
        $query = "INSERT INTO iB_Transactions (tr_code, account_id, acc_name, account_number, acc_type,  tr_type, tr_status, client_id, client_name, client_national_id, transaction_amt, balance,client_phone, receiving_acc_no, receiving_acc_name, receiving_acc_holder) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        //bind paramaters
        $rc = $stmt->bind_param('ssssssssssssssss', $tr_code, $account_id, $acc_name, $account_number, $acc_type, $tr_type, $tr_status, $client_id, $client_name, $client_national_id, $transaction_amt,$balance, $client_phone, $receiving_acc_no, $receiving_acc_name, $receiving_acc_holder);
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class=" col-md-4 form-group">
                                                    ...
                                                    <?php
                                                    //PHP function to generate random transaction code
                                                    $length = 10;
                                                ...
                                                <div class=" col-md-4 form-group">
                                                    <label for="exampleInputPassword1">Amount Transfered(GH₵)</label>
